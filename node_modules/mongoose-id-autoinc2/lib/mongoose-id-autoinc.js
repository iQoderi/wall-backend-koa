...
module.exports = new (function () {
  ...
  this.plugin = function(schema, options) {
    ...
    schema.pre('save', function (next) {
      ...
      if(doc[options.field] && options.once===true) {
        return next();
      }
  ...
  this.init = function (database, counter, mongoose) {

    db          = database;
    mongoose    = typeof counter === 'object' ? counter : mongoose
    counterName = typeof counter === 'string' ? counter : 'counter';
